  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div className="bg-[var(--bg-secondary)] rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden animate-scale-in shadow-2xl border border-[var(--bg-elevated)]">
          {/* Header */}
          <div className="flex items-center justify-between p-6 border-b border-[var(--bg-elevated)]">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-[var(--accent)] font-semibold text-lg">${product.price.toFixed(2)}</p>
              </div>
            </div>
            <button
              onClick={onClose}
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-32 bg-[var(--bg-elevated)] border border-[var(--bg-elevated)] rounded-lg px-3 py-2 text-white focus:outline-none focus:border-[var(--accent)]"
                    >
                      {[1, 2, 3, 4, 5].map(num => (
          ...
          {activeTab === 'details' && (
            <div className="flex gap-3 p-6 border-t border-[var(--bg-elevated)]">
              <button
                onClick={onClose}
